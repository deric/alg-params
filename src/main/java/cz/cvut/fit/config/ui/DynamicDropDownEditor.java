...
import cz.cvut.fit.config.context.Publisher;
import cz.cvut.fit.config.context.PublishingContext;
import cz.cvut.fit.config.context.Subscriber;
import cz.cvut.fit.config.ui.DynamicDropDown.Label;
                ...
                box.setRenderer(new DefaultListCellRenderer() {
                    ...
                    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                        ...
                        switch (labelType) {
                            case NAME:
                                if (value != null) {
                                    if (value.getClass().isAnnotationPresent(cz.cvut.fit.config.annotations.Component.class)) {
                                        label = value.getClass().getAnnotation(cz.cvut.fit.config.annotations.Component.class).name();
                                    }
