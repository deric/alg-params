...
import cz.cvut.fit.config.util.Annotations;
import cz.cvut.fit.config.util.PropertyExtractor;
...
public class PropertyConfigurationManager implements ConfigurationManager {
    ...
    public boolean isConfigurable(final Object o) {
        ...
        List<Field> properties = Annotations.filter(Arrays.asList(o.getClass().getDeclaredFields()), cz.cvut.fit.config.annotations.Property.class);
