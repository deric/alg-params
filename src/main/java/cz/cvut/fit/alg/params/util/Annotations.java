...
/**
 * <p>
 * Utility class for runtime processing of {@link Annotation}s.</p>
 *
 * @author ytoh
 */
public final class Annotations {
    ...
    /**
     * <p>
     * Retrieves from the supplied {@link AnnotatedElement} all annotations
     ...
     * @return a list of {@link Annotation}s that are annotated with the
     * specified metaannotation
     */
    ...
    /**
     * <p>
     * Filters the list of {@link AnnotatedElement}s leaving only elements
     ...
     * @return a list of <code>AnnotatedElement</code>s that are annotated with
     * <code>type</code>
     */
     ...
     *
     * <p>
     * The name of a component is specified in {@link Component#name}. If the
     * <code>Component</code> annotation is not present on the supplied type the
     * type's simple name is returned.</p>
     *
